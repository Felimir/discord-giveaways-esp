...
const GiveawaysMessages = {
    giveaway: '<@&692407589115527249>\n\n🎉 **SORTEO** 🎉',
    giveawayEnded: '<@&692407589115527249>\n\n🎉 **SORTEO FINALIZADO** 🎉',
    timeRemaining: '⏲ **|** Tiempo restante: **{duration}**',
    inviteToParticipate: '↪ **|** Reacciona con 🎉 para participar!',
    winMessage: '🎉 **|** Felicidades, {winners}! Obtiene(n) **{prize}**!',
    embedFooter: 'Todos tienen las mismas probabilidades de ganar!',
...
const GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: '🎉 **|** Nuevo(s) ganador(es) : {winners}! Felicidades!',
        error: '❌ **|** Participaciones inválidas, no fue(ron) seleccionado(s) ganador(es)!'
    }
};
