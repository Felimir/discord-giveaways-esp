...
class Giveaway extends EventEmitter {
    ...
    async fetchMessage() {
        return new Promise(async (resolve, reject) => {
            ...
            if (!message) {
                return reject('No se pudo obtener el mensaje con la ID ' + this.messageID + '.');
            }
    ...
    edit(options = {}) {
        return new Promise(async (resolve, reject) => {
            if (this.ended) {
                return reject('El sorteo con la ID ' + this.messageID + ' ya terminó.');
            }
            if (!this.channel) {
                return reject('No se pudo obtener el canal del sorteo con la ID ' + this.messageID + '.');
            }
    ...
    reroll(options){
        return new Promise(async (resolve, reject) => {
            if (!this.ended) {
                return reject('El sorteo con la ID ' + this.messageID + ' no terminó.');
            }
            if (!this.channel) {
                return reject('No se pudo obtener el canal del sorteo con la ID ' + this.messageID + '.');
            }
